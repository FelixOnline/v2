...
title: 'GDPR is a good start, but it’s up to us to protect our online privacy'
subtitle: >-
...
1. ask for incorrect, inaccurate or incomplete personal data to be corrected;
1. request that personal data be erased when it’s no longer needed or if processing it is unlawful;
1. object to the processing of your personal data for marketing purposes or on grounds relating to your particular situation;
1. request the restriction of the processing of your personal data in specific cases;
1. receive your personal data in a machine-readable format and send it to another controller (‘data portability’);
1. request that decisions based on automated processing concerning you or significantly affecting you and based on your personal data are made by natural persons, not only by computers. You also have the right in this case to express your point of view and to contest the decision.
...
As an individual, take the opportunity now to find out what information services collect about you. With exams over, why not download your Facebook data and play around with it if you are so inclined? 
Furthermore you do not have to agree to the terms and conditions if you are uncomfortable! Why not support efforts to make the web more open and try an alternative service such as DuckDuckGo instead of Google, or Telegram instead of WhatsApp. For more ideas on what you can do see below.
...
1. You don’t have to agree to the terms and conditions. Instead of Google, OneDrive, and WhatsApp why not try [DuckDuckGo Search](https://ddg.gg), [CryptPad](https://cryptpad.fr/), or [Telegram](https://telegram.org/), which offer equivalent services for free but do not collect unnecessary amounts of personalized information. The website “[PRISM Break](https://prism-break.org/en/all/)” has further suggestions. 
1. Take part in making a better web. Are you are interested in the effects of technology on society? Would like to be involved in raising awareness? Do you have an interest in building a better Internet? If so, please contact artur.donaldson15@imperial.ac.uk.
